...
class ProspectsControllerTest < ActionController::TestCase
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post :create, prospect: { email: @prospect.email, first_name: @prospect.first_name, last_name: @prospect.last_name, mobile: @prospect.mobile }
    end
  ...
  test "should update prospect" do
    patch :update, id: @prospect, prospect: { email: @prospect.email, first_name: @prospect.first_name, last_name: @prospect.last_name, mobile: @prospect.mobile }
    assert_redirected_to prospect_path(assigns(:prospect))
  end
